...
<div id="background">
	...
	<div id="middlecontent">
		<div id="aboutcontent">
			<h1>About</h1>
			<p>Float is an undergraduate organization that aims to bring more girls interested in technology and entrepreneurship into the Yale community. 
				However, anyone is welcome to participate in its programs. It provides student-run workshops in web development and design to anyone interested, 
				as well as a mentoring program to those considering the Computer Science major. All workshops and events are presented free-of-charge.
		...
		<div id="meettheteam">
			...
			<p>Torie Nielsen BR'16, President <br><br><img src="./images/torie.jpg" alt="Torie" style="float:left; margin: 0 20px 0 0;
			...
			<p>Austen James SM '17, Instructor <br><br><img src="./images/austen.jpg" alt="Austen" style="float:left; margin: 0 20px 0 0;
				border:solid; border-color:white; border-width: 10px; width: 150px; height=150px; overflow: hidden">
			...
			<p>Alison Visher TC '18, Instructor <br><br><img src="./images/ali.jpg" alt="Alison" style="float:left; margin: 0 20px 0 0;
				border:solid; border-color:white; border-width: 10px; width: 150px; height=150px; overflow: hidden">
			...
			<p>Christine Hong TC'15, Founder. <a href="www.linkedin.com/in/christinehong802">Contact Christine at LinkedIn</a>
 			<br><br><img src = "./images/christine-1.jpg" alt="Christine" style="float:left; margin: 0 20px 0 0;
				border:solid; border-color:white; border-width: 10px; width: 150px; height: 150px; overflow:hidden"></p>
